...
namespace Base2BaseWeb.B2B.DataLayer.Migrations
{
    ...
    [Migration("20180406150610_Changed_PhoneEmailFields_AllowNull")]
    partial class Changed_PhoneEmailFields_AllowNull
    {
            ...
            modelBuilder.Entity("Base2BaseWeb.B2B.DataLayer.Entities.ContactPhoneInfo", b =>
                {
                    ...
                    b.HasIndex("ContactFullName", "PhoneNumber")
                        .IsUnique()
                        .HasFilter("[ContactFullName] IS NOT NULL AND [PhoneNumber] IS NOT NULL");
